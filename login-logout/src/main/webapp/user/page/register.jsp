<%@ page import="com.example.loginlogout.entity.Account" %>
...
<section class="checkout spad" style="padding-top: 50px !important;">
    <div class="container">
            ...
            <form action="/register" method="post">
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        ...
                        <%}%>
                        <h6 class="checkout__title">Account form</h6>
                        <div class="row">
                            <div class="col-lg-6">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="footer__about">
                    <div class="footer__logo">
                        <a href="#"><img src="/user/img/footer-logo.png" alt=""></a>
                    </div>
